                    ...
                    EditorGUILayout.BeginVertical("Box");
                    {
                        ...
                        EditorGUILayout.BeginVertical("HelpBox");
                        {
                            ...
                            if (showBases && db.Bases.Count > 0)
                            {
                                EditorGUILayout.BeginVertical();
                                {
                                    ...
                                    for (var index = 0; index < db.Bases.Count; index++)
                                    {
                                        GameObject baseField = db.Bases[index];
                        ...
                        EditorGUILayout.BeginVertical("HelpBox");
                        {
                            ...
                            if (showSwivels && db.Swivels.Count > 0)
                            {
                                EditorGUILayout.BeginVertical();
                                {
                                    ...
                                    for (var index = 0; index < db.Swivels.Count; index++)
                                    {
                                        GameObject swivelField = db.Swivels[index];
                        ...
                        EditorGUILayout.BeginVertical("HelpBox");
                        {
                            ...
                            if (showHeads && db.Heads.Count > 0)
                            {
                                EditorGUILayout.BeginVertical();
                                {
                                    ...
                                    for (var index = 0; index < db.Heads.Count; index++)
                                    {
                                        GameObject headField = db.Heads[index];
                        ...
                        EditorGUILayout.BeginVertical("HelpBox");
                        {
                            ...
                            if (showMounts && db.Mounts.Count > 0)
                            {
                                EditorGUILayout.BeginVertical();
                                {
                                    ...
                                    for (var index = 0; index < db.Mounts.Count; index++)
                                    {
                                        GameObject mountField = db.Mounts[index];
                        ...
                        EditorGUILayout.BeginVertical("HelpBox");
                        {
                            ...
                            if (showBreeches && db.Breeches.Count > 0)
                            {
                                EditorGUILayout.BeginVertical();
                                {
                                    ...
                                    for (var index = 0; index < db.Breeches.Count; index++)
                                    {
                                        GameObject breechField = db.Breeches[index];
                        ...
                        EditorGUILayout.BeginVertical("HelpBox");
                        {
                            ...
                            if (showBarrels && db.Barrels.Count > 0)
                            {
                                ...
                                for (var index = 0; index < db.Barrels.Count; index++)
                                {
                                    GameObject barrelField = db.Barrels[index];
